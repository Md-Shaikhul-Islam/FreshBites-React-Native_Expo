...
export default function ProfileScreen() {
  const { user, isPremium, setPremium, userRole, setUserRole, setUser, logout } = useUser();
  ...
  // Editable profile fields - loaded from database only
  ...
  const loadUserData = async () => {
    ...
    try {
      ...
      if (freshUserData) {
        ...
        // Update local state with database values only
          ...
          <View style={styles.infoCard}>
            <View style={styles.infoRow}>
              ...
              {isEditing ? (
                ...
                <ThemedText type="defaultSemiBold">{name || 'Not set'}</ThemedText>
              )}
            </View>
            ...
            <View style={styles.infoRow}>
              ...
              {isEditing ? (
                ...
                <ThemedText type="defaultSemiBold">{email || 'Not set'}</ThemedText>
              )}
            </View>
            ...
            <View style={styles.infoRow}>
              ...
              {isEditing ? (
                ...
                <ThemedText type="defaultSemiBold">{phone || 'Not set'}</ThemedText>
              )}
            </View>
            ...
            <View style={styles.infoRow}>
              ...
              {isEditing ? (
                ...
                <ThemedText type="defaultSemiBold">{address || 'Not set'}</ThemedText>
              )}
            </View>
          </View>
